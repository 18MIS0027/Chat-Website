...
if(isset($_POST['delmsg']))
		  {
		          mysqli_query($con,"delete from message");
echo'<script> window.location="javascript:history.go(-1)"; </script> ';                       
}
if(isset($_POST['dellivemsg']))
		  {
		          mysqli_query($con,"delete from livechat");
echo'<script> window.location="javascript:history.go(-1)"; </script> ';                       
}
?>
<!DOCTYPE html>
...
<?php } ?>			
		...
		<form action="admin-user-msg.php" method="post">
	   <center><input type="submit" name="delmsg" value="Delete all messages"></center>
	   <center><input type="submit" name="dellivemsg" value="Delete all group chat messages"></center>
