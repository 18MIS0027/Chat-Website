...
if(isset($_POST['delmsg']))
		  {
		          mysqli_query($con,"delete from notesuser");
...
$sql = "SELECT users.name,notesuser.* FROM notesuser inner join users where notesuser.userid=users.id";		
...
<?php } ?>			
		...
		<form action="admin-user-notes.php" method="post">
